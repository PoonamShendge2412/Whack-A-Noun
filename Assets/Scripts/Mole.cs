...
public class Mole : MonoBehaviour {
  ...
  private int moleIndex = 0;
    ...
    public GameObject wordImage, rightImage, wrongImage;
  ...
  private IEnumerator QuickHide() {
    ...
    private void OnMouseDown()
    {
        ...
        if (wordType == "noun")
        {
            Debug.Log("Correct! It's a noun.");
            rightImage.SetActive(true);
            rightImage.transform.GetChild(1).GetComponent<TextMeshProUGUI>().text = "It's a " + wordType;
            gameManager.AddScore(moleIndex, 1);
        }
        else
        {
            Debug.Log("Wrong! Not a noun.");
            string article = GetArticle(wordType);
            wrongImage.SetActive(true);
            wrongImage.transform.GetChild(1).GetComponent<TextMeshProUGUI>().text = "It's " + article +" "+ wordType;
            gameManager.AddScore(moleIndex, -1);
        }
        spriteRenderer.sprite = moleHit;
  ...
  public void SetIndex(int index) {
    ...
    public void SetWord(GameManager.WordEntry entry)
    {
